...
const CircusClassic = () => {
  ...
  return (
    <div className="mt-20">
      <div>
        <span className="text-2xl">&lt;서커스 저글링&gt;</span>
        ...
        <aside>"클래식 음악과 현대 서커스의 유쾌한 만남"</aside>
        <br />

        <br />
        <span>
          나비넥타이가 지휘에 맞춰 춤을 추는 판타지 서커스. 서커스를 위한
          서커스가 아닌 클래식을 위한 서커스. 흥미진진한 오브제의 반전이
          시작된다.
        </span>
      </div>
      ...
      <div className="flex justify-center mt-10 w-full h-96">
        <iframe
          width="100%"
          height="100%"
          src="https://www.youtube.com/embed/xy1yUMjdClU"
